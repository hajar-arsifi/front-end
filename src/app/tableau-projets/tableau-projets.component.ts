...
@Component({
  selector: 'app-tableau-projets',
  templateUrl: './tableau-projets.component.html',
  styleUrls: ['./tableau-projets.component.css']
})
export class TableauProjetsComponent implements OnInit {
  ...
  constructor(private services : ContratsService, public projetService: GestionProjetService, private modalService: ModalManager, public saveProjetService : SaveProjetService) { }

  ngOnInit(): void {
    this.services.getContrats(this.currentPage,this.size)
      .subscribe((data :any)=>{
