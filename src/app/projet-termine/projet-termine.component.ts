...
@Component({
  selector: 'app-projet-termine',
  templateUrl: './projet-termine.component.html',
  styleUrls: ['./projet-termine.component.css']
})
export class ProjetTermineComponent implements OnInit {
  ...
  constructor(private services : ContratsService, private projetService: GestionProjetService, private router : Router,private activatedRoute: ActivatedRoute,
              private modalService: ModalManager, public saveProjetService : SaveProjetService) { }


  ngOnInit(): void {
    const id=this.activatedRoute.snapshot.params['id'];
    this.services.getProjetsTermines(this.currentPage,this.size)
    .subscribe((data :any)=>{
